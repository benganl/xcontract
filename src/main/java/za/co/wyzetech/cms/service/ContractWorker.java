...
public class ContractWorker {
    ...
    public ContractWorker(Workflow workflow, ContractService contractService,
                          ContractValidator contractValidator, ContractRepository contractRepository, JsonUtil jsonUtil) {
